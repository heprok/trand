...
final class Version20210708060900 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trend.trend (drec TIMESTAMP(0) WITH TIME ZONE NOT NULL, attribute_id INT NOT NULL, value SMALLINT NOT NULL, PRIMARY KEY(drec, attribute_id))');
